...
<div>
  ...
  <ul>
    ...
    <li>
      Procure atividades de inverno, principalmente exterior, que te agradem. Num país preparado para isso você não terá dificuldades de encontrar uma. Que tal uma sublistinha com algumas opções?: <ul>
        <li>
          Ski de fond;
        </li>
        <li>
